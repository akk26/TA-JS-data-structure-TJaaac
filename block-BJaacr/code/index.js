...
for (let detail of got.houses[1].people) {
  console.log(`I am ${detail.name} and my bio is ${detail.description}`);
}
...
for (let detail of got.houses[0].people) {
  console.log(`I am ${detail.name} and my bio is ${detail.description}`);
}
...
for (let detail of got.houses[1].people) {
  if (detail.name === "Tywin Lannister")
    console.log(`I am ${detail.name} and my bio is ${detail.description}`);
}
...
for (let total of allDescription) {
  if (total.length > 30)
    console.log(total);
}
